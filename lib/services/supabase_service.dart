...
class SupabaseService {
  ...
  // สร้าง methon ที่จะใช้กับ supabaseสำหรับการแก้ไขข้อมูลในฐานข้อมูล FoodTD in supabase
  ...
  // สร้าง methon ที่จะใช้กับ supabaseสำหรับการลบข้อมูลในฐานข้อมูล FoodTD in supabase
